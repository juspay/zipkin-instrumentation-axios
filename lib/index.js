...
class AxiosWrapper {
  ...
  /**
   * Makes a request with the provided config
   *
   */
  request(opt = {}) {
    return this.sendRequest(opt.url, opt)
  }
  ...
  /**
   * Creates an instance of axios with the given config
   *
   */
  create(opt = {}) {
    const newAxios = this.axios.create(opt)
    return new AxiosWrapper(newAxios, {
      tracer: this.tracer,
